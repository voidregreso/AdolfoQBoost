...
namespace qspower
{
    ...
    enum device_type
    {
        ...
        cpu_prime  = QSPOWER_DEVICE_TYPE_CPU_PRIME,
        cpu        = QSPOWER_DEVICE_TYPE_CPU_BIG | QSPOWER_DEVICE_TYPE_CPU_LITTLE | QSPOWER_DEVICE_TYPE_CPU_PRIME,
     ...
     *
     *  @param d device_type (e.g., cpu, cpu_big, cpu_little, cpu_prime, or gpu).
     *  @return std::string (e.g., "cpu", "cpu_big", "cpu_little", "cpu_prime", or "gpu").
     */
    ...
    public:
        ...
        */
        ...
        /**
        *  @brief Query if CPU Prime core is part of the device_set.
        *
        *  Query if CPU Prime core is part of the device_set.
        *
        *  @return
        *  <code>true</code> if CPU Prime core present,\n
        *  <code>false</code> otherwise.
        */
        bool on_cpu_prime() const;
